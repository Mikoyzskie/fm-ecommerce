    ...
    return (
        <div className='flex gap-4 flex-col lg:flex-row'>
            <div className='flex items-center justify-between lg:justify-normal bg-slate-100 rounded-md gap-11'>
                <button className='py-5 pl-10 lg:pl-3' onClick={handleMinus}>
                ...
                <button className='py-5 pr-10 lg:pr-3' onClick={() => { setCount(count + 1) }}>
            ...
            <button className='flex items-center justify-center grow bg-[#ff7d1a] rounded-md text-white font-bold shadow-2xl shadow-[#ff7d1a] gap-4 py-4 active:bg-[#ffede0] active:text-[#ff7d1a] group' onClick={handleActive} >
