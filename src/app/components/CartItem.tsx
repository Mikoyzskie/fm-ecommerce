...
export default function CartItem() {
    ...
    return (
        <>
            <div className='flex justify-between items-center'>
                <div className='flex gap-4'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <p className='text-slate-500'>$125.00 x {cartCount} <span className='font-bold text-black'>${125 * cartCount}.00</span></p>
                    </div>
                </div>
                <button className='' onClick={() => { setCartCount(0) }}>
            ...
            <button className='font-bold p-4 bg-[#ff7d1a] text-white rounded-lg active:opacity-50'>Checkout</button>
        </>
    )
}